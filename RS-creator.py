...
def initiate_report_creation(compound, df_rrf, df_sample_prep, chrom_input, area_input, input_list):
...
if __name__ == '__main__':
    ...
    initiate_report_creation(compound, df_rrf, df_sample_prep, chrom_input, area_input, input_list)
